  ...
  return (
    <div className="flex flex-col justify-center items-center h-screen w-screen">
      ...
      <div className="text-white flex justify-center items-center">
        <button className="bg-slate-600 px-7 py-4 " onClick={handleCreateCall}>Create</button>
      </div>
      ...
      <div className="flex justify-between items-center border-2 border-gray-300 rounded">
        ...
        <p className="text-gray-700">don't have an accout yet? Click <NavLink to={"/"} className="text-blue-500" >here</NavLink> to sign up</p>
    </div>
  )
};
