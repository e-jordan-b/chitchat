...
const AuthModal: React.FC<{ isVisible: boolean; onClose: () => void }> = ({
  ...
  return (
    <FullscreenModal>
      ...
      <div className="shadow-md h-2/4 max-h-[600px] min-h-[400px] w-96 flex flex-col items-center justify-around bg-white dark:bg-gray-800 rounded-md relative">
      <h1 className="text-3xl dark:text-custom-purple-50 select-none">Sign in to your account</h1>
      <form>
        <div className="flex flex-col justify-center items-center h-auto w-auto">
          <label className='relative cursor-pointer'>
            ...
            />
            <span className='text-1xl text-black text-opacity-80 bg-white absolute left-5 top-1 px-2 rounded-md transition duration-200 input-text'>Email</span>
          </label>
          <label className='relative cursor-pointer'>
            <input
              type="password"
            ...
            />
            <span className='text-1xl text-black text-opacity-80 bg-white absolute left-5 top-1 px-2 py-0 transition rounded-md duration-200 input-text'>Password</span>
          </label>
        </div>
