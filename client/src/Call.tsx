...
const Call: React.FC = () => {
  ...
  const webcamButton = document.querySelector('#webcamButton') as HTMLButtonElement;
  const webcamVideo = document.querySelector('#webcamVideo') as HTMLVideoElement;
  ...
  return (
    <>
      ...
      <input id="callInput" />
      <button id="answerButton" disabled={disabled.answerButtonDisable}>Answer</button>
